...
for i, row in df.iterrows():
    try:
        point = Point(MEASUREMENT).tag("userID", str(row['id'])).tag("pa", str(row['pa']))
        
        for field in ["stepcount", "activityscore", "sed2upr", "upr2sed", "uprtime", "steptime", "dchan1", "dchan2", "dchan3"]:
